      ...
      <main className="block">
        <div className="mx-auto max-w-6xl flex flex-col lg:flex-row justify-between items-center px-2 lg:px-0">
          <section className="max-w-2xl">
            <h1 className="text-3xl lg:text-5xl mt-5 md:mt-28 mb-5 text-center md:text-left"><span className="text-dark-green-sweetdreams">Sweet</span> <span className="text-dark-pink-sweetdreams">Dreams</span> Candy Store</h1>
